...
@__const.main.arr = private unnamed_addr constant [5 x i8] c"Hello", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_arrays.cpp, ptr null }]
...
define dso_local noundef i32 @main(i32 noundef %0, ptr noundef %1) #4 {
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %6, ptr align 1 @__const.main.arr, i64 5, i1 false)
  %7 = getelementptr inbounds [5 x i8], ptr %6, i64 0, i64 4
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_arrays.cpp() #0 {
...
attributes #4 = { mustprogress noinline norecurse nounwind optnone uwtable "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
